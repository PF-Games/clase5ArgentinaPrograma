...
/*
    ...
    También podemos crear (declarar) y darle valor (asignar)
    a una variable en un solo paso (la INICIALIZAMOS).

    let nuevaVariable = 1;

    */

//let nombre = 'Pablo Daniel'
...
//let diez = 10
//let tres = 3
//let resultadoDeMultiplicacion = diez * tres
...
let añoDeNacimiento = Number (prompt("¿en qué año naciste?"));

function calcular(añoActual, añoDeNacimiento) {
    return añoActual - añoDeNacimiento
console.log(
    calcular(añoActual, añoDeNacimiento)
    )
...
}else{console.log('El operador ' + operador + ' no es válido, ingresa un operador +, -, /, o *')}
...
else if(nombreDeUsuario === nombreEsposa){
    console.log(`Hola ${nombreDeUsuario}, te llamás igual que mi esposa.`)
}
else{console.log(`Hola, ${nombreDeUsuario}`)
}

const miEdad = 33

let edadDeUsuario = Number (prompt('¿Cuál es tu edad?'))

if(edadDeUsuario === miEdad){
    console.log('Tenemos la misma edad')}
else if(edadDeUsuario < miEdad){
    console.log('Yo soy mayor')
}
else{console.log ('yo soy menor')}
*/
